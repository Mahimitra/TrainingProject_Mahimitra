		...
		<div class="row">
			...
			<div class="col-md-3">
				...
				<form action="register" method="post">
					name:<br> <input type="text" name="f1"><br>
					<br> email:<br> <input type="text" name="f2"><br>
					<br> password:<br> <input type="password" name="f3"><br>
			...
			<div class="col-md-3">
				...
				<form action="login" method="post">
					email:<br> <input type="text" name="f1"><br>
					<br> password:<br> <input type="password" name="f2"><br>
